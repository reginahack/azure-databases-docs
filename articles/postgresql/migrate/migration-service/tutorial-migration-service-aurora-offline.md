---
title: "Migrate Offline, from an Amazon Aurora PostgreSQL to Azure Database for PostgreSQL, Using the Migration Service in Azure"
description: "Learn to migrate, seamlessly and in offline mode, from an Amazon Aurora PostgreSQL to Azure Database for PostgreSQL, using the migration service in Azure."
author: apduvuri
...
This article guides you in migrating an Amazon Aurora PostgreSQL instance to Azure Database for PostgreSQL flexible server in offline mode.
...
1. Select **Create** to go through a wizard-based series of tabs to perform a migration to a flexible server from an Amazon Aurora PostgreSQL.
    ...
    :::image type="content" source="media/tutorial-migration-service-aurora-offline/create-migration.png" alt-text="Screenshot of the Setup tab which appears after selecting Create in the Migration page." lightbox="media/tutorial-migration-service-aurora-offline/create-migration.png":::
...
- **Source server type** - Depending on your PostgreSQL source, you can select **Amazon Aurora PostgreSQL**.
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/setup-migration.png" alt-text="Screenshot of the Setup tab after providing necessary details."  lightbox="media/tutorial-migration-service-aurora-offline/setup-migration.png":::
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/summary-migration.png" alt-text="Screenshot of the Summary migration tab." lightbox="media/tutorial-migration-service-aurora-offline/summary-migration.png":::
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/monitor-migration.png" alt-text="Screenshot of the monitor migration page." lightbox="media/tutorial-migration-service-aurora-offline/monitor-migration.png":::
